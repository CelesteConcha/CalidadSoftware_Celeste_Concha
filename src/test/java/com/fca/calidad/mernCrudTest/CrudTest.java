...
public class CrudTest {
  ...
  @Test
  public void testMernCrud() throws Exception {
    ...
    driver.findElement(By.name("email")).sendKeys("A19211565@amino.com");
    ...
    driver.findElement(By.name("name")).click();
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("A192115656");
    driver.findElement(By.name("email")).click();
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("a19211565654@amino.com");
    driver.findElement(By.name("age")).click();
    driver.findElement(By.name("age")).clear();
