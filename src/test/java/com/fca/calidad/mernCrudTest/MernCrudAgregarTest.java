...
public class MernCrudAgregarTest {
	private WebDriver driver;
	  ...
	  public void testAgregar() throws Exception {
	    ...
	    driver.findElement(By.name("name")).sendKeys("Prueva12345");
	    driver.findElement(By.name("email")).click();
	    driver.findElement(By.name("email")).clear();
	    driver.findElement(By.name("email")).sendKeys("prueva12345@net.com");
	    ...
	    System.out.println("El usuario se agregó correctamente");
	  }
